  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 py-4">
      <div>
        ...
        <h1 className="font-head text-2xl font-bold mt-3">プライバシーポリシー</h1>
        <p className="text-sm text-ink-muted mt-1">最終更新日：2025年1月1日</p>
      </div>
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-ink leading-relaxed">
          ...
          <a href="https://tools.google.com/dlpage/gaoptout" className="text-accent-500 hover:underline" target="_blank" rel="noopener noreferrer">
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-ink leading-relaxed">
          ...
          <a href="https://policies.google.com/technologies/ads" className="text-accent-500 hover:underline" target="_blank" rel="noopener noreferrer">
            Google の広告ポリシー
          </a>
          をご覧ください。
          パーソナライズ広告を無効にしたい場合は、
          <a href="https://www.google.com/settings/ads" className="text-accent-500 hover:underline" target="_blank" rel="noopener noreferrer">
            広告設定ページ
          </a>
          からオプトアウトできます。
        </p>
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-ink leading-relaxed">
          本ポリシーに関するお問い合わせは、
          <Link href="/contact" className="text-accent-500 hover:underline">お問い合わせページ</Link>
          よりご連絡ください。
        </p>
      </section>
    </div>
