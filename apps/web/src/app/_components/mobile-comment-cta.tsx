...
export function MobileCommentCta({ targetId = "comment-form" }: { targetId?: string }) {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="sm:hidden fixed left-4 right-4 z-30 min-h-12 bg-accent-600 text-white text-sm font-semibold rounded-full shadow-lg flex items-center justify-center gap-1.5"
