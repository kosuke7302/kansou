  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 py-4">
      <div>
        ...
        <h1 className="font-head text-2xl font-bold mt-3">利用規約</h1>
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-ink leading-relaxed">ユーザーは以下の行為を行ってはなりません。</p>
        <ul className="text-sm text-ink space-y-1 list-disc list-inside leading-relaxed">
