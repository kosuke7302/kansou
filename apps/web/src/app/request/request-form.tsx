      ...
      <form action={action} className="space-y-4">
        ...
        <div className="space-y-1">
          <label htmlFor="type" className="text-sm font-medium text-ink">
            ジャンル
            <span className="text-ink-muted text-xs font-normal ml-1">（わかれば）</span>
          </label>
          <select
            id="type"
            name="type"
        ...
        <div className="space-y-1">
          <label htmlFor="note" className="text-sm font-medium text-ink">
            補足
            <span className="text-ink-muted text-xs font-normal ml-1">（配信先、シリーズ名など）</span>
          </label>
          <textarea
            id="note"
            name="note"
        ...
        <div className="space-y-1">
          <label htmlFor="requesterName" className="text-sm font-medium text-ink">
            お名前
            <span className="text-ink-muted text-xs font-normal ml-1">（省略可）</span>
          </label>
          <input
            id="requesterName"
            name="requesterName"
